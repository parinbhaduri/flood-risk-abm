...
##Try ensemble run
adf_100, _ = ensemblerun!([risk_abm_100_high risk_abm_100_low], agent_step!, model_step!, 50; adata)
...
#plot flood depths
levee_depth = copy(risk_abm_high.Flood_depth)
levee_depth[levee_depth .< GEV_return(1/100)] .= 0
model_plot_100 = Plots.plot(adf_100.step[1:51], levee_depth[1:51], legend = false,
